...
ADRs live in `knowledge-base/adr/` and use sequential numbering: `0001-slug.md`, `0002-slug.md`, etc.

Create the `knowledge-base/adr/` directory lazily — only when the first ADR is needed.
